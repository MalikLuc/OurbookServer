...
import com.example.v2ourbook.dto.BookShelfInviteRequestDto;
import com.example.v2ourbook.dto.FriendRequestDto;
import com.example.v2ourbook.dto.GetBookProcessDto;
import com.example.v2ourbook.dto.GetBookRequestDto;
...
import com.example.v2ourbook.services.BookClubService;
import com.example.v2ourbook.services.GetBookProcessService;
import com.example.v2ourbook.services.MessageService;
import com.example.v2ourbook.services.RequestService;
...
import static com.example.v2ourbook.enums.GetBookStatus.AGREED;
...
public class RequestController {
    ...
    public Integer RequestsDashStat() throws Exception {
        return getBookRequestRepository.countAllByGiverAndRequestResult(userController.getCurrentUser(), RequestResult.init("pending"));
    }
    ...
    public GetBookProcessDto respondGetBookRequest(@RequestBody @PathVariable(value = "id") Long requestId, boolean accept) throws ExceptionBlueprint, ExecutionException, InterruptedException {
        ...
        if (accept) {
            ...
            messageService.createSystemMessage("System Ourbook Message", process.getId());
